...
const SingleProduct = () => {
  ...
  return (
    ...
    <div  className="max-w-6xl mx-auto mb-10 mt-2 p-6 bg-slate-300 shadow-lg rounded-lg flex flex-col md:flex-row gap-10">
        {/* Product Images */}
      ...
      {/* Product Details */}
      <div className="md:w-1/2 flex flex-col mt-16">
        ...
        <p className="text-sm text-gray-500">
          Stock: {singleProduct.stock} available
        </p>
